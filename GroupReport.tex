...
\begin{table}[h!]
    ...
    %  5 & 88 & 788 & 6344 \\ [1ex] 
     \hline
    \end{tabular}
    \caption{Table comparing different fuel cells\cite{doe2006factsheet}\cite{deloitte2020FuelCell}}
...
\begin{table}[h!]
    \centering
    \begin{tabular}{|p{0.18\textwidth}|p{0.36\textwidth}||p{0.34\textwidth}|} %{|l||c|c|c|c|}
    \hline
...
\begin{table}[h!]
    \centering
    \begin{tabular}{|p{0.2\textwidth}|p{0.36\textwidth}||p{0.34\textwidth}|}%{|l|l|l|}%{|p{0.18\textwidth}|p{0.38\textwidth}||p{0.38\textwidth}|} %{|l||c|c|c|c|}
    \hline
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{testriglayout.jpg}
...
\begin{figure}[h!]\label{fig:ganttChart} 
    \includegraphics[width=0.72\paperheight,angle=90]{GanttChart28_08_2022.jpg}
    % \caption{The layout of the test rig}
    \centering
\end{figure}
